...
const content = (<div>
    <ul>
        ...
        <li><GaryLangProjectLink/> - A (semi failed but very interesting) attempt into constructing a compiler for a esoteric langauge straight from the hellscape of my imagination</li>
