...
const content = (<div>
    ...
    <ul class="wrap">
        <li>At {GilmondLink} as a QA Test Professional <em>(10/2017 - 03/2018)</em></li>
        {/* <li>At {GilmondLink} (again!) as a Software Developer to present day <em>(03/2018 - now!)</em></li> */}
    </ul>
</div>);
